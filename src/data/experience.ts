...
export const experienceData: Experience[] = [
  {
    ...
    location: "Remote",
    description:
      "Developing web management system for digital marketing and advertising. Building custom graphic designer web application for news articles with modern technology stack.",
    achievements: [
    ...
    technologies: ["Angular", "TypeScript", ".NET Core", "Node.js", "Express", "MySQL", "Docker", "Git", "Canva"],
  },
  {
    id: "2",
    ...
    description:
      "Returned to develop hospital management solutions with telehealth features. Managed database systems and Windows Server infrastructure while providing deployment and user training.",
    achievements: [
  ...
  },
  {
    ...
    location: "Remote",
    description:
      "Developed comprehensive accounting management solutions with Xero API integration. Worked on construction SaaS projects and migration management systems for business process optimization.",
    achievements: [
  ...
  },
  {
    ...
    location: "Philippines",
    description:
      "Developed hospital management solutions including telehealth features. Managed databases and Windows Server infrastructure. Handled deployment and conducted user training sessions.",
    achievements: [
  ...
  },
  {
    ...
    location: "Philippines",
    description:
      "Taught programming and IT courses to university students. Developed communication and leadership skills through teaching experience while sharing technical knowledge.",
    achievements: [
    ...
    technologies: ["Java", "C#", "JavaScript", "HTML", "CSS", "Database Design"],
  },
];
